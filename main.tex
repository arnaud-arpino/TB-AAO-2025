...
\pagenumbering{roman} 
\input{Chapitres/0-Prembule.tex} 
...
\input{Chapitres/1-Intro.tex}
\input{Chapitres/2-CDC.tex}
\input{Chapitres/3-Cat-sol.tex}
\input{Chapitres/4-Tests_des_sols.tex}
\input{Chapitres/5-Realisation.tex}
\input{Chapitres/6-Programmation.tex}
\input{Chapitres/7-Conclusion.tex}
\input{Chapitres/97-Signatures.tex}
\input{Chapitres/98-Remerciements.tex}
